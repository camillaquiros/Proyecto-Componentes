...
function App() {
	...
	return (
		<main 
  className="min-h-screen w-screen flex items-center justify-center bg-[url('assets/img/back.jpg')] bg-cover bg-center bg-no-repeat">
			<form className="flex flex-col gap-5 items-center border-[3px] border-[#007575] bg-white rounded-md w-full max-w-md px-8 py-10"
